...
public class GFG {
     /**
* <h1>maximum bipartite matching algorithm</h1>
* This class implements the maximum bipartite matching algorithm for task 2 
* Displays the maximum bipartite matching
o Displays the Maximum number of applicants that can be assigned to the hospitals  
* <p>
* 
* 
*
